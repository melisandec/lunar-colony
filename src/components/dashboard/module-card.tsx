    ...
    <div draggable={draggable} onDragStart={onDragStart}>
      ...
      >
        ...
        <div
          ...
          title={`${module.efficiency}% efficiency`}
        />

        {/* Level badge */}
        <div className="absolute -left-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-slate-800 text-[8px] font-bold text-slate-300">
          {module.level}
        </div>
      </motion.div>
    </div>
